...
(defn ^V1Pod task-metadata->pod
  ...
  (let [{:keys [scalar-requests job]} task-request
        ...
        sidecar-workdir-volume (when sidecar (make-volume "cook-sidecar-workdir-volume"))
    ...
    (.setVolumes pod-spec (filterv some? (conj volumes workdir-volume init-container-workdir-volume sidecar-workdir-volume)))
